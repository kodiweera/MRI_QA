...
while (scalar(@oldARGV)) {
  ...
  if ($opt eq 'help') {
    ...
    print "Version: " . 'BXH/XCEDE utilities (1.11.1)' . "\n";
    exit 0;
...
print $logfh "fmriqa_generate.pl version " . 'BXH/XCEDE utilities (1.11.1)' . "\n";
...
print HTMLFH <<EOM;
  ...
  <p style="font-size: smaller;">BXH/XCEDE utilities (1.11.1)</p>
EOM
print HTMLFH <<EOM;
  </div>
EOM
